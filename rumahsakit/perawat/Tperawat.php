...
<body>
  ...
  <div class="container">
    ...
    <section class="main">
      <div class="main-top">
        <p>SILAHKAN INPUTKAN DATA PERAWAT!</p>
      </div>
      <div class="main-body">
    ...
    <?php
        ...
        $data = mysqli_query($koneksi,"select * from perawat limit $halaman_awal, $batas");
    ...
    ?>
            <tr>
                ...
                <td>
                    <a href="edit.php?id_perawat=<?php echo $d['id_perawat']; ?>" onclick="return confirm ('yakin mau edit ?');" class="btn btn-outline-success">
                    <i class="fas fa-pen"></i> </a></td>
                    <td><a href="hapus.php?id_perawat=<?php echo $d['id_perawat']; ?>" onclick="return confirm ('yakin mau hapus ?');" class="btn btn-outline-danger">
