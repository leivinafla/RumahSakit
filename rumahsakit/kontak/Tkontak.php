    ...
    <nav>
      <div class="navbar">
        ...
        <ul>
          ...
          <li><a href="../pasien/Tpasien.php">
            <i class="fas fa-user"></i>
            <span class="nav-item">Pasien</span>
          </a>
          </li>
          <li><a href="../perawat/Tperawat.php">
            <i class="fas fa-hospital-user"></i>
            <span class="nav-item">Perawat</span>
          </a>
          </li>
                ...
                <div class="border">
                    <div class="jarak">
                        ...
                        <table border="1">
                            ...
                            <td><p align="justify">www.rumahsakitpusat</p></td>
                            </tr>
                        </table>
                    </div></div>
                </div>
